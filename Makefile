EE_BIN = MEST-CHIPELINO.elf
EE_BIN_COMPRESSED = compressed_$(EE_BIN)

EE_OBJS = main.o \
	Data/pad.o Data/stateManager.o Data/introState.o Data/menuState.o Data/gameState.o Data/overState.o Data/soundEffects.o Data/musicManager.o Data/textToGraphics.o Data/player.o Data/enemy.o libsd.o padman.o
